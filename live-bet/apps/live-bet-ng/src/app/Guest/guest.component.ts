...
@Component({
  ...
  `,
  styles: [
    ".draw-container { height: 100%;}",
    "mat-drawer { width: 400px; background-color: rgb(100, 100, 100); color: white; }",
    ".router { overflow-y: auto; height: 100%; }",
    ".ticket-fab { position: absolute; top: 50%; right: 0; z-index: 1; background-color: white !important; color: rgb(100, 100, 100) !important; font-size: 16px; }",
